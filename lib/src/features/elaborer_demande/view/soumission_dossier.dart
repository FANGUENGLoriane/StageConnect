              ...
              const SizedBox(
               ...
               Center(
                child: Padding(
                  ...
                  child: Text(
                    'La formation en genie logiciel est plus axé dans le cadre de la programmation.  ici, on retrouve des langages '
                        'de programmations tels que :   Java , Java Script, Python, Dart et bien dautres. Tous dépend du "programmeur"',
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(filesTexts[i], style: GoogleFonts.roboto(color: Colors.deepOrangeAccent),),
                                Icon(Icons.upload_file,color: Colors.deepOrangeAccent,)
                                //arrow_forward_ios
                              ],
                            ),
                          ),
