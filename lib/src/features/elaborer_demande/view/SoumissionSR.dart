...
class SoumissionSR extends StatefulWidget {
  const SoumissionSR({
    super.key,
  });

  @override
  State<SoumissionSR> createState() => _SoumissionSRState();
}

class _SoumissionSRState extends State<SoumissionSR> {
        ...
        body: Padding(
          ...
          child: ListView(children: [
            ...
            Column(children: [
              ...
              const Center(
                child: Text(
                  'C\'est une spécialité de l\'informatique qui se concentre sur la conception et l\'inplémenta-\ntion des réeaux sécurisées,'
                   ' Elle mise sur la connaissance des protocoles de communi-\ncation et des technologies réseau ',
